...
export namespace ResourcePath {
  export function resourcePath(value: Utils.SourceArray, index: number, metadataContext?: any): Lexer.Token {
    ...
    let token = ResourcePath.batch(value, index) || ResourcePath.entity(value, index, metadataContext) || ResourcePath.metadata(value, index);
  ...
  export function collectionNavigationPath(value: Utils.SourceArray, index: number, metadataContext?: any): Lexer.Token {
    let start = index;
    let token = ResourcePath.collectionPath(value, index, metadataContext) || Expressions.refExpr(value, index);
    if (token) return token;
  ...
  export function singleNavigation(value: Utils.SourceArray, index: number, metadataContext?: any): Lexer.Token {
    let token =
      ResourcePath.boundOperation(value, index, false, metadataContext) || Expressions.refExpr(value, index) || Expressions.valueExpr(value, index);
    if (token) return token;
  ...
  export function collectionPath(value: Utils.SourceArray, index: number, metadataContext?: any): Lexer.Token {
    return Expressions.countExpr(value, index) || ResourcePath.boundOperation(value, index, true, metadataContext);
  }

  export function singlePath(value: Utils.SourceArray, index: number, metadataContext?: any): Lexer.Token {
    return Expressions.valueExpr(value, index) || ResourcePath.boundOperation(value, index, false, metadataContext);
  }
  ...
  export function functionParameter(value: Utils.SourceArray, index: number, metadataContext?: any): Lexer.Token {
    ...
    let token = Expressions.parameterAlias(value, index) || PrimitiveLiteral.primitiveLiteral(value, index);
