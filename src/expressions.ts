...
export namespace Expressions {
  ...
  export function boolCommonExpr(value: Utils.SourceArray, index: number): Lexer.Token {
    ...
    let expr = andExpr(value, token.next) || orExpr(value, token.next);
  ...
  export function fractionalsecondsMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token {
  ...
  export function totalOffsetMinutesMethodCallExpr(value: Utils.SourceArray, index: number): Lexer.Token {
  ...
  export function memberExpr(value: Utils.SourceArray, index: number): Lexer.Token {
    ...
    let next = propertyPathExpr(value, index) || boundFunctionExpr(value, index);
  ...
  export function keyValuePair(value: Utils.SourceArray, index: number): Lexer.Token {
    let prop = NameOrIdentifier.primitiveKeyProperty(value, index) || keyPropertyAlias(value, index);
  ...
  export function complexPathExpr(value: Utils.SourceArray, index: number): Lexer.Token {
    ...
    let expr = propertyPathExpr(value, index) || boundFunctionExpr(value, index);
  ...
  export function functionExprParameter(value: Utils.SourceArray, index: number): Lexer.Token {
    ...
    let param = parameterAlias(value, index) || parameterValue(value, index);
  ...
  export function parameterValue(value: Utils.SourceArray, index: number): Lexer.Token {
    let token = ArrayOrObject.arrayOrObject(value, index) || commonExpr(value, index);
